...
+ (instancetype)makeWithUri:(NSString *)uri
       ...
       forwardBufferDurationMs:(nullable NSNumber *)forwardBufferDurationMs {
  FVPCreationOptions *pigeonResult = [[FVPCreationOptions alloc] init];
  pigeonResult.uri = uri;
  pigeonResult.httpHeaders = httpHeaders;
  pigeonResult.forwardBufferDurationMs = forwardBufferDurationMs;
  return pigeonResult;
}
+ (FVPCreationOptions *)fromList:(NSArray<id> *)list {
  FVPCreationOptions *pigeonResult = [[FVPCreationOptions alloc] init];
  ...
  pigeonResult.forwardBufferDurationMs = GetNullableObjectAtIndex(list, 2);
  return pigeonResult;
}
+ (nullable FVPCreationOptions *)nullableFromList:(NSArray<id> *)list {
...
- (NSArray<id> *)toList {
  return @[
    ...
    self.forwardBufferDurationMs ?: [NSNull null],
  ];
}
@end
