...
- (instancetype)initWithPlayerItem:(AVPlayerItem *)item
  ...
  // Note: item.preferredForwardBufferDuration is configured upstream in
  // FVPVideoPlayerPlugin's playerItemWithCreationOptions: (LOCAL PATCH) from
  // VideoPlayerOptions.forwardBufferDuration.
